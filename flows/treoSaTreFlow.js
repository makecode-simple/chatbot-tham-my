...
async function sendTreoSaTreFlow(sender_psid) {
  console.log("🚀 Trigger Treo Sa Trễ Flow");
  
  await messengerClient.sendMessage(sender_psid, {
    text: `Dạ chào chị, xin phép chị cho em giới thiệu về phương pháp phẫu thuật TREO SA TRỄ KHÔNG ĐAU bằng dao mổ siêu âm Ultrasonic Surgical Scalpel chị xem qua ạ.
...
module.exports = sendTreoSaTreFlow;