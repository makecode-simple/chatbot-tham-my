...
async function sendChinhMuiLoiFlow(sender_psid) {
  ...
  const bangGiaImage = await getBangGiaImage("banggia_chinhmuiloi");
  if (bangGiaImage) {
    await messengerClient.sendMessage(sender_psid, {
...
module.exports = sendChinhMuiLoiFlow;