...
async function sendTaiTaoVuFlow(sender_psid) {
  ...
  const bangGiaImage = await getBangGiaImage("banggia_taitaovu");
  if (bangGiaImage) {
    await messengerClient.sendMessage(sender_psid, {
