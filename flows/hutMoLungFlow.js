...
async function sendHutMoLungFlow(sender_psid) {
  ...
  const bangGiaImage = await getBangGiaImage("banggia_hutmolung");
  if (bangGiaImage) {
    await messengerClient.sendMessage(sender_psid, {
