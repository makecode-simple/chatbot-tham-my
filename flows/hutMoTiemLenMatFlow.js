...
async function sendHutMoTiemLenMatFlow(sender_psid) {
  ...
  const bangGiaImage = await getBangGiaImage("banggia_hutmotienmat");
  if (bangGiaImage) {
    await messengerClient.sendMessage(sender_psid, {
...
module.exports = sendHutMoTiemLenMatFlow;