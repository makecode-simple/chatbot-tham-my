...
async function sendChinhMatLoiFlow(sender_psid) {
  ...
  const bangGiaImage = await getBangGiaImage("banggia_chinhmatloi");
  if (bangGiaImage) {
    await messengerClient.sendMessage(sender_psid, {
...
module.exports = sendChinhMatLoiFlow;